...
directory= 'E:\\Chrome Download\\3 min Etch\\3 min Etch'
tm_directory = 'E:\\Chrome Download\\3 min Etch\\3 min Etch\\TM'
te_directory = 'E:\\Chrome Download\\3 min Etch\\3 min Etch\\TE'
...
for file, ax in zip(tm_files, flat_tm_axes):
    ...
    wave, background = np.genfromtxt(os.path.join(directory,background_file[1]), unpack=True, delimiter=',')
